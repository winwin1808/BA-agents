export const BA_AGENTS_MCP_SKILL_MARKDOWN = [
  ...
  "description: 'Use when the task needs BA Agents MCP to retrieve trusted BSS B2B Suite context, open canonical documents, check changelog wording, recommend a minimal context bundle, generate a very basic reference UI from a confirmed UX/UI task, or generate a workflow diagram artifact for BA/PM work. Covers Lock, Quote/Quick, Solution, and cross-suite BA/PM work.'",
  "---",
  "",
  "# Use BA Agents MCP",
  "",
  "## Overview",
  "",
  "Use this skill when the answer should come from the BA Agents MCP instead of memory. The MCP is the trusted retrieval layer for BSS B2B Suite BA/PM context, the entry point for low-fidelity reference UI generation, and the workflow artifact generator for BPMN-style diagrams.",
  "",
  "## Preconditions",
  "",
